...
export default function Home() {
  ...
  useEffect(() => {
    const debouncedAdjust = debounce(adjust, 10);
    ...
    <div className="parenthome" ref={mainref}>
      ...
      <div className="maincontent">
        <div className="titlebar">
          ...
          <div className="fmactitle" ref={fmactitleref}>
            <p>
              <strong>
                ...
                <span className="disappearingtext" ref={disappearingtextref1}>
                  ilm{" "}
                </span>
                <span className="hightlighttext" ref={highlighttextref2}>
                  Ma<span className="dot"></span>
                </span>
                <span className="disappearingtext" ref={disappearingtextref2}>
                  king{" "}
                </span>
                <span className="hightlighttext" ref={highlighttextref3}>
                  C
                </span>
                <span className="disappearingtext" ref={disappearingtextref3}>
                  lub
                </span>
                <span className="hightlighttext" ref={highlighttextref4}>
                  &nbsp;BITS GOA
                </span>
              </strong>
            </p>
          ...
          <div className="date">
            <p ref={dateref}>Established 2016...</p>
          </div>
        </div>
                ...
                <div className="news2">
                  <div className="newsbox">
                    ...
                    <p className="newstag tag2">
                      Waves curtain raiser "Sheesha" receives 6k views, becoming
                      the fastest spreading FMaC video!
                    </p>
                  </div>
                </div>
                <div className="news3">
                ...
                <div className="news5">
                  <div className="newsbox">
                    ...
                    <p className="newstag tag5">
                      "Aaja", FMaC's preincuction film premiers in the
                      auditorium!!
                    </p>
                  </div>
                </div>
